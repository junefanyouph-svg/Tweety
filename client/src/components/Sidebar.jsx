...
export default function Sidebar() {
  ...
  return (
    <div className="w-[260px] h-screen bg-bg-dark border-r border-border-dark flex flex-col p-6 px-4 fixed left-0 top-0 z-[100] max-md:hidden">
      <div className="text-[1.5rem] font-bold text-primary cursor-pointer mb-8 px-3 flex items-center gap-2" onClick={() => navigate('/feed')}>
        🐦 <span className="text-[1.4rem]">Tweety</span>
      </div>
